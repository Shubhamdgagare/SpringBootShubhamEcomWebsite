...
(function ($) {
  ...
  jQuery(document).ready(function ($) {
    ...
    $(window)
      .resize(function () {
        if (current_width != $(window).width()) {
          ...
          $(
            ".single .post-detail iframe, .wp-block-embed__wrapper iframe"
          ).each(function () {
            let width, height;
    ...
    if (typeof $.fn.slick != "undefined") {
      $(".post-slider").slick({
        ...
        centerPadding: "120px",
        prevArrow:
          '<span class="zoo-carousel-btn prev-item"><i class="cs-font clever-icon-arrow-left-5"></i></span>',
        nextArrow:
          '<span class="zoo-carousel-btn next-item "><i class="cs-font clever-icon-arrow-right-5"></i></span>',
        centerMode: true,
        responsive: [
          {
            breakpoint: 768,
    ...
    if ($(".widget_categories, .widget_nav_menu, .widget_pages")[0]) {
      $(".widget_categories, .widget_nav_menu, .widget_pages").each(
        function () {
          $(this)
            .find(".children, .sub-menu")
            .parent()
            .append(
              '<span class="cs-font clever-icon-down toggle-view"></span>'
            );
        }
      );
    ...
    if (zooThemeSettings.enable_dev_mode === "1") {
      ...
      if (zooThemeSettings.isRtl || $body.hasClass("rtl")) {
        $("#zoo-theme-dev-actions").append(
          '<a class="button action-link" href="' +
            currentUrl +
            queryMark +
            'text-direction=ltr">LTR</a>'
        );
      } else {
        $("#zoo-theme-dev-actions").append(
          '<a class="button action-link" href="' +
  ...
  function zoo_comment_form_field() {
    ...
    $(document).on(
      "focusin",
      ".wrap-text-field input, .wrap-text-field textarea",
      function () {
    ...
    zoo_lazyImg: function () {
      if ($(this)[0]) {
        ...
        if (typeof deferimg != "undefined") {
          deferimg(this.selector + ":not(.sec-img)", 0, "loaded", function () {
  ...
  $(document).on(
    "click",
    ".zoo-list-categories .zoo-ln-toggle-view",
    function (event) {
